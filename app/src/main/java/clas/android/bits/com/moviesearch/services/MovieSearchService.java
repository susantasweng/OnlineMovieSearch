...
import clas.android.bits.com.moviesearch.BuildConfig;
...
public class MovieSearchService {
    ...
    public static MovieDetailsModel getDetail(String imdbId) throws IOException {
        setsOmdbApi();

        Call<MovieDetailsModel> call = sOmdbApi.Detail(imdbId);
